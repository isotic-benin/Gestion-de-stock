...
// Les rôles autorisés pour la gestion des dépenses sont Administrateur
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true || !in_array($_SESSION['role'], ['Administrateur', 'Caissier'])) {
