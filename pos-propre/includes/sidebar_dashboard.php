...
$menu_items = [
    ...
    [
        ...
        'module_dir' => 'clients',
        'sub_menus' => [
            ['title' => 'Clients', 'icon' => 'fas fa-user-friends', 'link' => BASE_URL . 'modules/clients/gerer_clients.php', 'roles' => ['Administrateur', 'Caissier', 'Vendeur']],
            ['title' => 'Comptes Épargne', 'icon' => 'fas fa-piggy-bank', 'link' => BASE_URL . 'modules/clients/gerer_comptes_epargne.php', 'roles' => ['Administrateur', 'Caissier']],
            ['title' => 'Dettes Clients', 'icon' => 'fas fa-money-bill-wave', 'link' => BASE_URL . 'modules/clients/gerer_dettes_clients.php', 'roles' => ['Administrateur', 'Caissier']],
        ]
    ],
    [
        ...
        'module_dir' => 'produits',
        'sub_menus' => [
            ['title' => 'Produits & Stock', 'icon' => 'fas fa-box-open', 'link' => BASE_URL . 'modules/produits/gerer_produits_stock.php', 'roles' => ['Administrateur', 'Gérant']],
            ['title' => 'Transferts de Stock', 'icon' => 'fas fa-truck-ramp-box', 'link' => BASE_URL . 'modules/produits/gerer_transferts_stock.php', 'roles' => ['Administrateur', 'Gérant']],
        ]
    ],
    [
        'title' => 'Ventes',
        ...
        'module_dir' => 'ventes',
        'sub_menus' => [
            ['title' => 'Point de Vente (PdV)', 'icon' => 'fas fa-calculator', 'link' => BASE_URL . 'modules/ventes/point_de_vente.php', 'roles' => ['Administrateur', 'Vendeur']],
            ['title' => 'Historique des Ventes', 'icon' => 'fas fa-history', 'link' => BASE_URL . 'modules/ventes/historique_ventes.php', 'roles' => ['Administrateur', 'Vendeur']],
            ['title' => 'Retours de Vente', 'icon' => 'fas fa-undo', 'link' => BASE_URL . 'modules/ventes/retours_ventes.php', 'roles' => ['Administrateur', 'Vendeur']],
        ]
    ],
    [
        'title' => 'Finances',
        ...
        'module_dir' => 'finance',
        'sub_menus' => [
            ['title' => 'Dépenses', 'icon' => 'fas fa-money-bill-wave', 'link' => BASE_URL . 'modules/finance/gerer_depenses.php', 'roles' => ['Administrateur', 'Caissier']],
            ['title' => 'Dettes Magasins', 'icon' => 'fas fa-file-invoice-dollar', 'link' => BASE_URL . 'modules/finance/gerer_dettes_entreprise.php', 'roles' => ['Administrateur']],
        ]
    ],
    [
        'title' => 'Fournisseurs',
        ...
        'sub_menus' => [
            ['title' => 'Fournisseurs', 'icon' => 'fas fa-dolly', 'link' => BASE_URL . 'modules/fournisseurs/gerer_fournisseurs.php', 'roles' => ['Administrateur']],
        ]
    ],
    [
        'title' => 'Paramètres',
        ...
        'sub_menus' => [
            ['title' => 'Configuration', 'icon' => 'fas fa-building', 'link' => BASE_URL . 'modules/parametres/configuration_entreprise.php', 'roles' => ['Administrateur']],
            ['title' => 'Magasins', 'icon' => 'fas fa-store-alt', 'link' => BASE_URL . 'modules/magasins/gerer_magasins.php', 'roles' => ['Administrateur']],
            ['title' => 'Personnels', 'icon' => 'fas fa-users', 'link' => BASE_URL . 'modules/magasins/gerer_personnel.php', 'roles' => ['Administrateur']],
        ]
    ],
    [
        'title' => 'Statistiques',
        ...
        'module_dir' => 'rapports',
        'sub_menus' => [
            ['title' => 'Statistiques Générales', 'icon' => 'fas fa-chart-line', 'link' => BASE_URL . 'modules/rapports/statistiques_rapports.php', 'roles' => ['Administrateur']],
        ]
    ],
...
<div id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto p-3 space-y-1">
        ...
        <?php foreach ($menu_items as $item): ?>
            <?php
            $has_access_parent = in_array($user_role, $item['roles']);
            ...
            if (isset($item['sub_menus'])) {
                foreach ($item['sub_menus'] as $sub_item) {
                    if (in_array($user_role, $sub_item['roles']) && isActive($sub_item['link'], $current_page, basename(dirname(parse_url($sub_item['link'], PHP_URL_PATH))), $current_module_dir)) {
                        ...
                        <?php if (isset($item['sub_menus'])): ?>
                            <div id="<?php echo str_replace(' ', '-', $item['title']); ?>"
                                ...
                                <?php foreach ($item['sub_menus'] as $sub_item): ?>
                                    <?php if (in_array($user_role, $sub_item['roles'])): ?>
