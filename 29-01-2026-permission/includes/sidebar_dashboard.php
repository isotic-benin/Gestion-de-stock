...
$menu_items = [
    ...
    [
        ...
        'roles' => ['Administrateur', 'Caissier', 'Vendeur'],
        'module_dir' => 'clients',
        'module_code' => 'clients',
        'sub_menus' => [
            ['title' => 'Clients', 'icon' => 'fas fa-user-friends', 'link' => BASE_URL . 'modules/clients/gerer_clients.php', 'roles' => ['Administrateur', 'Caissier', 'Vendeur'], 'module_code' => 'clients'],
            ['title' => 'Comptes Épargne', 'icon' => 'fas fa-piggy-bank', 'link' => BASE_URL . 'modules/clients/gerer_comptes_epargne.php', 'roles' => ['Administrateur', 'Caissier'], 'module_code' => 'comptes_epargne'],
            ['title' => 'Dettes Clients', 'icon' => 'fas fa-money-bill-wave', 'link' => BASE_URL . 'modules/clients/gerer_dettes_clients.php', 'roles' => ['Administrateur', 'Caissier'], 'module_code' => 'dettes_clients'],
        ]
    ],
    [
        'title' => 'Produits & Stock',
        'icon' => 'fas fa-boxes',
        'roles' => ['Administrateur', 'Gérant'],
        'module_dir' => 'produits',
        'module_code' => 'produits',
        'sub_menus' => [
            ['title' => 'Produits & Stock', 'icon' => 'fas fa-box-open', 'link' => BASE_URL . 'modules/produits/gerer_produits_stock.php', 'roles' => ['Administrateur', 'Gérant'], 'module_code' => 'produits'],
            ['title' => 'Transferts de Stock', 'icon' => 'fas fa-truck-ramp-box', 'link' => BASE_URL . 'modules/produits/gerer_transferts_stock.php', 'roles' => ['Administrateur', 'Gérant'], 'module_code' => 'transferts_stock'],
        ]
    ],
    [
        'title' => 'Ventes',
        'icon' => 'fas fa-cash-register',
        'roles' => ['Administrateur', 'Vendeur'],
        'module_dir' => 'ventes',
        'module_code' => 'ventes',
        'sub_menus' => [
            ['title' => 'Point de Vente (PdV)', 'icon' => 'fas fa-calculator', 'link' => BASE_URL . 'modules/ventes/point_de_vente.php', 'roles' => ['Administrateur', 'Vendeur'], 'module_code' => 'ventes'],
            ['title' => 'Historique des Ventes', 'icon' => 'fas fa-history', 'link' => BASE_URL . 'modules/ventes/historique_ventes.php', 'roles' => ['Administrateur', 'Vendeur'], 'module_code' => 'ventes'],
            ['title' => 'Retours de Vente', 'icon' => 'fas fa-undo', 'link' => BASE_URL . 'modules/ventes/retours_ventes.php', 'roles' => ['Administrateur', 'Vendeur'], 'module_code' => 'retours_ventes'],
        ]
    ],
    [
        'title' => 'Finances',
        ...
        'sub_menus' => [
            ['title' => 'Dépenses', 'icon' => 'fas fa-money-bill-wave', 'link' => BASE_URL . 'modules/finance/gerer_depenses.php', 'roles' => ['Administrateur', 'Caissier'], 'module_code' => 'depenses'],
            ['title' => 'Dettes Magasins', 'icon' => 'fas fa-file-invoice-dollar', 'link' => BASE_URL . 'modules/finance/gerer_dettes_entreprise.php', 'roles' => ['Administrateur'], 'module_code' => 'dettes_entreprise'],
        ]
    ],
    [
        'title' => 'Fournisseurs',
        ...
        'sub_menus' => [
            ['title' => 'Fournisseurs', 'icon' => 'fas fa-dolly', 'link' => BASE_URL . 'modules/fournisseurs/gerer_fournisseurs.php', 'roles' => ['Administrateur'], 'module_code' => 'fournisseurs'],
        ]
    ],
    [
        'title' => 'Paramètres',
        ...
        'sub_menus' => [
            ['title' => 'Configuration', 'icon' => 'fas fa-building', 'link' => BASE_URL . 'modules/parametres/configuration_entreprise.php', 'roles' => ['Administrateur'], 'module_code' => 'parametres'],
            ['title' => 'Permissions', 'icon' => 'fas fa-user-shield', 'link' => BASE_URL . 'modules/parametres/gerer_permissions.php', 'roles' => ['Administrateur'], 'module_code' => 'parametres'],
            ['title' => 'Magasins', 'icon' => 'fas fa-store-alt', 'link' => BASE_URL . 'modules/magasins/gerer_magasins.php', 'roles' => ['Administrateur'], 'module_code' => 'magasins'],
            ['title' => 'Personnels', 'icon' => 'fas fa-users', 'link' => BASE_URL . 'modules/magasins/gerer_personnel.php', 'roles' => ['Administrateur'], 'module_code' => 'personnel'],
        ]
    ],
    [
        'title' => 'Statistiques',
        ...
        'sub_menus' => [
            ['title' => 'Statistiques Générales', 'icon' => 'fas fa-chart-line', 'link' => BASE_URL . 'modules/rapports/statistiques_rapports.php', 'roles' => ['Administrateur'], 'module_code' => 'rapports'],
        ]
    ],
                                ...
                                <?php foreach ($item['sub_menus'] as $sub_item): ?>
                                    <?php if (checkMenuAccess($sub_item, $user_role, $conn)): ?>
                                        <a href="<?php echo $sub_item['link']; ?>"
                                            class="flex items-center px-3 py-2 text-xs rounded-md text-gray-400 hover:bg-gray-600 hover:text-white transition duration-200 <?php echo isActive($sub_item['link'], $current_page, basename(dirname(parse_url($sub_item['link'], PHP_URL_PATH))), $current_module_dir) ? 'bg-gray-600 text-white font-medium' : ''; ?>">
