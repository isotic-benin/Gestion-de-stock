...
// Vérifier les permissions d'accès au module ventes (lecture)
if (!hasPermission($conn, 'ventes', 'read')) {
                                ...
                                <?php if (!empty($ventes)): ?>
                                    <?php foreach ($ventes as $vente): ?>
                                        <tr <?php echo ($vente['nombre_retours'] > 0) ? 'class="bg-yellow-50"' : ''; ?>>
                                            <td>
                                                ...
                                                <?php if ($vente['nombre_retours'] > 0): ?>
                                                    <span
                                                        ...
                                                        title="Cette vente a <?php echo $vente['nombre_retours']; ?> retour(s)">
                                                        <i class="fas fa-undo-alt mr-1"></i> <?php echo $vente['nombre_retours']; ?>
                                                        retour(s)
                                                    </span>
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td><?php echo number_format($vente['montant_total'], 2, ',', ' ') . ' ' . htmlspecialchars(get_currency()); ?>
                                            </td>
                                            <td><?php echo number_format($vente['montant_recu_espece'], 2, ',', ' ') . ' ' . htmlspecialchars(get_currency()); ?>
                                            </td>
                                            <td><?php echo number_format($vente['montant_recu_momo'], 2, ',', ' ') . ' ' . htmlspecialchars(get_currency()); ?>
                                            </td>
                                            <td><?php echo number_format($vente['montant_change'], 2, ',', ' ') . ' ' . htmlspecialchars(get_currency()); ?>
                                            </td>
                                            <td><?php echo number_format($vente['montant_du'], 2, ',', ' ') . ' ' . htmlspecialchars(get_currency()); ?>
                                            </td>
                                            <td>
                                                <?php
