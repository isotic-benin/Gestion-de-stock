...
// Vérifier les permissions d'accès au module parametres (lecture)
if (!hasPermission($conn, 'parametres', 'read')) {
    header("location: " . BASE_URL . "dashboard.php?error=access_denied");
    exit;
}

// Définir les permissions pour l'affichage conditionnel
$can_update = hasPermission($conn, 'parametres', 'update');
    ...
    <div class="flex-1 flex flex-col overflow-hidden md:ml-64">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6 pb-20">
            <div class="container mx-auto">
                ...
                <!-- Contenu Configuration Entreprise -->
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <form method="POST" action="">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="nom">Nom entreprise
                                    *</label>
                            ...
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="devise">Devise
                                    *</label>
