...
// Vérifier les permissions d'accès au module retours ventes
if (!hasPermission($conn, 'retours_ventes', 'read')) {
...
$can_create_return = hasPermission($conn, 'retours_ventes', 'create');
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['process_return'])) {
    // Vérifier la permission de création (retour)
    if (!$can_create_return) {
        $message = '<div class="alert alert-error">Vous n\'avez pas la permission d\'enregistrer un retour.</div>';
