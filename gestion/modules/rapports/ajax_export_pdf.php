...
<body>
    <div class="container">
        ...
        <div class="header-info">
            ...
            <p>Généré par: <?php echo htmlspecialchars($_SESSION['username']); ?>
                (<?php echo htmlspecialchars($_SESSION['role']); ?>)</p>
            <?php if (!empty($start_date) || !empty($end_date)): ?>
                <p>Période: Du <?php echo !empty($start_date) ? date('d/m/Y', strtotime($start_date)) : 'début'; ?> au
                    <?php echo !empty($end_date) ? date('d/m/Y', strtotime($end_date)) : 'présent'; ?></p>
            <?php endif; ?>
        ...
        <div class="footer">
            <p>&copy; <?php echo date('Y'); ?> <?php echo htmlspecialchars(($company_info['nom'] ?? 'HGB Multi')); ?>.
